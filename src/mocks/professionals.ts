...
export const MOCK_PROFESSIONALS: Professional[] = [
  {
    id: 'f1',
    clinicId: 'c1', code: 'PRO-000001', name: 'Dra. Camila Duarte', specialty: 'Clínica Geral', license: 'CRM/SE 12345', status: 'active', color: '#3B82F6',
  ...
  {
    id: 'f2',
    clinicId: 'c1', code: 'PRO-000002', name: 'Dra. Paula Menezes', specialty: 'Odontologia', license: 'CRO/SE 4567', status: 'active', color: '#14B8A6',
  ...
  {
    id: 'f3',
    clinicId: 'c1', code: 'PRO-000003', name: 'Dr. Bruno Teixeira', specialty: 'Fisioterapia', license: 'CREFITO-16 78901', status: 'active', color: '#10B981',
  ...
  {
    id: 'f4',
    clinicId: 'c1', code: 'PRO-000004', name: 'Dr. André Villas', specialty: 'Psicologia', license: 'CRP-19 2345', status: 'active', color: '#EC4899',
  ...
  {
    id: 'f5',
    clinicId: 'c1', code: 'PRO-000005', name: 'Dra. Renata Campos', specialty: 'Nutrição', license: 'CRN-5 6789', status: 'active', color: '#F59E0B',
  ...
  {
    id: 'f6',
    clinicId: 'c1', code: 'PRO-000006', name: 'Dr. Felipe Araújo', specialty: 'Dermatologia', license: 'CRM/SE 23456', status: 'inactive', color: '#8B5CF6',
