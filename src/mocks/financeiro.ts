import type {
  Adquirente, CaixaSessao, ContaBancaria, ContaPagar, ContaReceber, FluxoCaixaDia, MovimentoCaixa,
} from '@/types/domain'

// ── Caixa do dia ─────────────────────────────────────────────────────────────
export const MOCK_MOVIMENTOS_CAIXA: MovimentoCaixa[] = [
...
export const MOCK_FLUXO_DIAS: FluxoCaixaDia[] = [
...
export const MOCK_CONTAS_BANCARIAS: ContaBancaria[] = [
  { id: 'cb1', nome: 'BB — Conta PJ',    tipo: 'corrente', banco: 'Banco do Brasil', agencia: '1234-5', conta: '45.678-9',   titular: 'Neo Saúde LTDA', saldo: 12480.55, ativa: true, padrao: true },
  { id: 'cb2', nome: 'Nubank PJ',        tipo: 'corrente', banco: 'Nubank',          agencia: '0001',   conta: '9876543-2',  titular: 'Neo Saúde LTDA', saldo: 5320.10,  ativa: true },
  { id: 'cb3', nome: 'Reserva Poupança', tipo: 'poupanca', banco: 'Caixa Econômica', agencia: '0402',   conta: '00123456-7', titular: 'Neo Saúde LTDA', saldo: 20150,    ativa: true },
]

// ── Adquirentes ──────────────────────────────────────────────────────────────
export const MOCK_ADQUIRENTES: Adquirente[] = [
  {
...
export const MOCK_CAIXA_SESSAO: CaixaSessao = {
  aberto: false,
  valorAbertura: 0,
}
